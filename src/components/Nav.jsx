            ...
            <div class="flex gap-4 pointer-events-auto">
                <a href="tel:9142490309">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        class="feather feather-phone text-[#b0b2c3] hover:text-[#fff]">
                        <path
                ...
                <a href="https://wa.me/9142490309?text=Hi,How are you?" target="_blank">
                    <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="whatsapp"
                        class="svg-inline--fa fa-whatsapp fa-w-14 hover:text-[#25D366] text-[#b0b2c3]" role="img"
